  ...
  return (
    ...
    <div className="w-full max-w-md bg-white shadow-md rounded-lg p-8">
      ...
      <div className='font-semibold text-xl items-center text-center'> 
        ...
        <h1 className="text-xl font-semibold mb-6 text-black">Register</h1>
        <select value={role} onChange={(e)=>{setRole(e.target.value)}} on className="w-full p-2 mb-4 border rounded-md text-black">
          <option value="">Select Role</option>
          <option value="user">user</option>
          <option value="admin">admin</option>
        </select>
      <div className="mb-4 "> 
      <input type="text" placeholder="Enter your name" value={name} onChange={(e)=>{setName(e.target.value)}} className="w-full p-2 border rounded-md text-black"/>
      </div>
      <div className="mb-4">
      ...
      <div className="mb-4">
      <input type="number" placeholder="Enter your phone number" value={phone} onChange={(e)=>{setPhone(e.target.value)}} className="w-full p-2 border rounded-md text-black"/>
      </div>
      <div className="mb-4">
      ...
      <select value={education} onChange={(e)=>{setEducation(e.target.value)}} className="w-full p-2 mb-4 border rounded-md text-black">
        ...
        <div className="flex items-center mb-4">
          <div className="photo w-20 h-20 mr-4 text-black border rounded-xl">
          <img src={photoPreview ? photoPreview : "default-image.png"} alt="photo" className="w-full h-full object-cover " />
          </div>
            <input type="file" onChange={photoHandler} className="w-full p-2 border rounded-md text-black" />
        </div>
        <p className="text-center mb-4 text-black">Already register?&nbsp;&nbsp; <Link to={"/login"} className="text-blue-700 ">Login now</Link></p>
